...
let Datetime = class {
  ...
  renderTimeOverlay(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return [(0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      "aria-haspopup": "true",
      onClick: function () {
        var _ref = (0,_Users_josemunoz_Documents_Desarrollo_web_entorno_cliente_Unit_3_Ionic_svTickets_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
          const {
            popoverRef
          } = _this4;
